...
/**
 * Classe utilitária para realizar derivação simbólica e simplificação de
 * expressões.
...
public class Derivador {
    ...
    private static Expressao simplificarRecursivo(Expressao e) {
        ...
        if (e instanceof ExpSoma) {
            ...
            if (esq instanceof ValorInteiro && ((ValorInteiro) esq).valor() == 0)
                return dir;
            if (dir instanceof ValorInteiro && ((ValorInteiro) dir).valor() == 0)
                return esq;
        ...
        if (e instanceof ExpMenos) {
            ...
            // 1. Regra do -0 e -(-e)
            if (exp instanceof ValorInteiro && ((ValorInteiro) exp).valor() == 0)
                return new ValorInteiro(0);
            if (exp instanceof ExpMenos)
                return simplificarRecursivo(((ExpMenos) exp).getExp());
        ...
        if (e instanceof ExpMult) {
            ...
            if (esq instanceof ValorInteiro && ((ValorInteiro) esq).valor() == 1)
                return dir;
            if (dir instanceof ValorInteiro && ((ValorInteiro) dir).valor() == 1)
                return esq;
